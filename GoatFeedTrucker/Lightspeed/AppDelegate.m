...
#define ITUNES_URL @"http://itunes.apple.com/app/id547080360";
...
- (void) onPushAccepted:(PushNotificationManager *)manager withNotification:(NSDictionary *)pushNotification {
	...
	if(pushExtraData) {
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Hi there!" message:pushExtraData delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"OK", nil];
		[alert show];
		[alert release];
	}
}
...
{    
    if ([[AdsManager sharedAdsManager] needsUpdating])
    {
        ...
        UIAlertView *alert = [[[UIAlertView alloc] initWithTitle:@"Hey!" 
                                                         message:@"A new version of Lightspeed Getaway is available. Download Now?"
                                                        delegate:self 
...
-(NSString*) getRandomLocalPushMessage
{
    ...
    switch (rand) {
        case 0:
            message = @"I Just Jacked An Alien Spaceship, Lets Go For A Joyride.";
            break;
        case 1:
            message = @"Quick, The Aliens Are Angry, Lets Blow Them Up In Space.";
            break;
        case 2:
            message = @"Do You Have 2 Minutes? I Want You To Blow Up Some Alien Spaceships.";
            break;
        case 3:
            message = @"Someone Just Beat Your High Score! Lets Go For A Stolen Space Ship Joyride.";
            break;
        case 4:
            message = @"Are You Ok? You Haven't Blowed Up Aliens Lately...Wanna Shoot Lasers With Me?";
            break;
        case 5:
            message = @"Quick! Space Aliens From Space Need Lasering! Only You Can Prevent Boredom.";
            break;
        default:
            message = @"";
    }
